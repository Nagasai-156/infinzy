            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-center gap-y-2 lg:gap-y-4">
                ...
                <div className="flex justify-center w-full px-4">
                  <motion.span
                    className="inline-block pb-2 text-[1.75rem] xs:text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-[0.10em] sm:tracking-widest uppercase" style={{ fontFamily: "'Poppins', sans-serif" }}
