    ...
    useEffect(() => {
        ...
        const program = new Program(gl, {
            ...
            uniforms: {
                ...
                uTint: { value: new Float32Array([tintVec[0], tintVec[1], tintVec[2]]) },
                uMouse: {
        ...
        if (mouseReact) ctn.addEventListener('mousemove', handleMouseMove as EventListener);

        return () => {
            cancelAnimationFrame(rafRef.current);
            resizeObserver.disconnect();
            if (mouseReact) ctn.removeEventListener('mousemove', handleMouseMove as EventListener);
